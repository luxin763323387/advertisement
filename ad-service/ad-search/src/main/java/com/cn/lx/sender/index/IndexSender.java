package com.cn.lx.sender.index;

import com.alibaba.fastjson.JSON;
import com.cn.lx.Index.DateLevel;
...
public class IndexSender implements ISender {
    ...
    public void sender(MySqlRowData rowData) {
        ...
        if (DateLevel.LEVEL2.getLeve().equals(level)) {
            Level2RowData(rowData);
        } else if (DateLevel.LEVEL3.getLeve().equals(level)) {
            Level3RowData(rowData);
        } else if (DateLevel.LEVEL4.getLeve().equals(level)) {
