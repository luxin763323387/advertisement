package com.cn.lx.dump;

public class DConstant {

    //文件目录名
    public static final String DATA_ROOT_DIR = "E:\\Users\\stevenlu\\IdeaProjects\\lxad\\mysql_data\\";
    ...
    public static final String AD_AD_CREATIVE_UNIT = "ad_creative_unit.data";
